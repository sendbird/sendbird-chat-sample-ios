...
SWIFT_CLASS("_TtC15SendbirdChatSDK10ChatLogger")
...
@property (nonatomic, strong) SBDGroupChannelChangeLogsParams * _Nonnull changeLogsParams;
...
@interface SBDGroupChannelCollection (SWIFT_EXTENSION(SendbirdChatSDK))
...
@property (nonatomic, copy) NSDictionary<NSString *, SBDBaseMessage *> * _Nonnull pendings;
...
@property (nonatomic, copy) NSDictionary<NSString *, SBDBaseMessage *> * _Nonnull faileds;
...
@interface SBDMessageCollection (SWIFT_EXTENSION(SendbirdChatSDK))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull ChangeNotification;)
+ (NSNotificationName _Nonnull)ChangeNotification SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface SBError (SWIFT_EXTENSION(SendbirdChatSDK))
...
@interface SBDScheduledUserMessage (SWIFT_EXTENSION(SendbirdChatSDK)) <Mappable>
/// Initialize with json dictionary
- (nullable instancetype)initWithDictionary:(NSDictionary<NSString *, id> * _Nonnull)json SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
/// Converts the object into dictionary
- (NSDictionary<NSString *, id> * _Nonnull)_toDictionary SWIFT_WARN_UNUSED_RESULT;
