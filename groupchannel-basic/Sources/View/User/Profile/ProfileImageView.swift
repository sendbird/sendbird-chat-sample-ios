...
public class ProfileImageView: UIView {
    ...
    private lazy var mainImageView: UIImageView = {
        let mainImageView = UIImageView(image: BasicGroupChannelAsset.imgDefaultProfileImage1.image)
    ...
    private lazy var subImageViews: [UIImageView] = (0..<4).map { _ in
        let imageView = UIImageView(image: BasicGroupChannelAsset.imgDefaultProfileImage1.image)
    ...
    public func setImage(withCoverUrl coverUrl: String) {
        ...
        if let url = URL(string: coverUrl){
            mainImageView.kf.setImage(with: url, placeholder: BasicGroupChannelAsset.imgDefaultProfileImage1.image)
        } else {
            mainImageView.image = BasicGroupChannelAsset.imgDefaultProfileImage1.image
        }
    }
...
extension UIImageView {
    ...
    private func defaultUserProfileImage(user: User) -> UIImage? {
        ...
        return BasicGroupChannelAsset.imgDefaultProfileImage1.image
    }
