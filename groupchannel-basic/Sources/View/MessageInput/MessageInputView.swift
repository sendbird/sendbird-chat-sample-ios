...
public class MessageInputView: UIView {
    ...
    private lazy var sendFileMessageButton: UIButton = {
        ...
        sendFileMessageButton.setImage(BasicGroupChannelAsset.imgBtnSendFileMsgNormal.image, for: .normal)
        sendFileMessageButton.setImage(BasicGroupChannelAsset.imgBtnSendFileMsgPressed.image, for: .highlighted)
    ...
    private lazy var sendUserMessageButton: UIButton = {
        ...
        sendUserMessageButton.setImage(BasicGroupChannelAsset.imgBtnSendUserMsgPressed.image, for: .normal)
