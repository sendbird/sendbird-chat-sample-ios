...
public class SelectableUserTableViewCell: UITableViewCell {
    ...
    private lazy var checkImageView = UIImageView(image: BasicOpenChannelAsset.imgListChecked.image)
    ...
    public var selectedUser: Bool = false {
        didSet {
            checkImageView.image = selectedUser ? BasicOpenChannelAsset.imgListChecked.image : BasicOpenChannelAsset.imgListUnchecked.image
        }
    }
