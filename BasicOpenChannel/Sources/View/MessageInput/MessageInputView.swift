...
public class MessageInputView: UIView {
    ...
    private lazy var sendFileMessageButton: UIButton = {
        ...
        sendFileMessageButton.setImage(BasicOpenChannelAsset.imgBtnSendFileMsgNormal.image, for: .normal)
        sendFileMessageButton.setImage(BasicOpenChannelAsset.imgBtnSendFileMsgPressed.image, for: .highlighted)
    ...
    private lazy var sendUserMessageButton: UIButton = {
        ...
        sendUserMessageButton.setImage(BasicOpenChannelAsset.imgBtnSendUserMsgPressed.image, for: .normal)
