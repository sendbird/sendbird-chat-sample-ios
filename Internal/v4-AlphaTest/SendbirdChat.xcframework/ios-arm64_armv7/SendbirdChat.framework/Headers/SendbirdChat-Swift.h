...
///
- (void)messageCollection:(SBDMessageCollection * _Nonnull)collection context:(SBDMessageContext * _Nonnull)context channel:(SBDBaseChannel * _Nonnull)channel deletedMessages:(NSArray<SBDBaseMessage *> * _Nonnull)deletedMessages;
...
/// \param collection Message collection object.
///
- (void)didDetectHugeGapInMessageCollection:(SBDMessageCollection * _Nonnull)collection;
@end
