...
public class SelectableUserTableViewCell: UITableViewCell {
    ...
    private lazy var checkImageView = UIImageView(image: BasicGroupChannelAsset.imgListChecked.image)
    ...
    public var selectedUser: Bool = false {
        didSet {
            checkImageView.image = selectedUser ? BasicGroupChannelAsset.imgListChecked.image : BasicGroupChannelAsset.imgListUnchecked.image
        }
    }
