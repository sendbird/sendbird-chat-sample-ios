...
extension GroupChannelViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let message = messageListUseCase.messages[indexPath.row]
        let messageInfoController = GroupChannelUnReadMembersListViewController(channel: channel, message: message)
        navigationController?.pushViewController(messageInfoController, animated: true)
    }
