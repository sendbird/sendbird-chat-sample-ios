...
class OpenChannelViewController: UIViewController {
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.register(AddExtraDataMessageCell.self)
    ...
    public private(set) lazy var addExtraDataMessageUseCase = AddExtraDataToMessageUseCase(channel: channel)
...
extension OpenChannelViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let fileMessage = message as? FileMessage {
            ...
            let cell: AddExtraDataMessageCell = tableView.dequeueReusableCell(for: indexPath)
