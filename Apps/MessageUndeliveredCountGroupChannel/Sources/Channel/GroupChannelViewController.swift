...
class GroupChannelViewController: UIViewController {
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.register(MessageUndeliveredStatusCell.self)
    ...
    public private(set) lazy var messageUndeliveredCountUseCase = MessageUndeliveredMembersCountUseCase(channel: channel)
...
extension GroupChannelViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let fileMessage = message as? FileMessage {
            ...
            let cell: MessageUndeliveredStatusCell = tableView.dequeueReusableCell(for: indexPath)
            cell.updateMessageDetails(
                with: message,
                undeliveredCountUseCase: messageUndeliveredCountUseCase
            )
            return cell
        }
    }
